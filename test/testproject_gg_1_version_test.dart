...
void main() {
  group('testproject_gg_1_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/testproject_gg_1_version.dart');

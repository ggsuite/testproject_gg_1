...
import '../../bin/testproject_gg_1.dart';

void main() {
  /*group('bin/testproject_gg_1.dart', () {
    // #########################################################################

    test('should be executable', () async {
      // Execute bin/testproject_gg_1.dart and check if it prints help
      final result = await Process.run(
        './bin/testproject_gg_1.dart',
        ['my-command'],
        stdoutEncoding: utf8,
        stderrEncoding: utf8,
      );
  ...
  group('run(args, log)', () {
    group('with args=[--param, value]', () {
      test('should print "value"', () async {
        // Execute bin/testproject_gg_1.dart and check if it prints "value"
